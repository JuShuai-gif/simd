...
set(CMAKE_CUDA_COMPILER_LIBRARY_ROOT_FROM_NVVMIR_LIBRARY_DIR "/usr/local/cuda-12.4/nvvm/libdevice")
...
message(STATUS "++++Found CUDA CUDAToolkit_INCLUDE_DIRS "+${CUDA_TOOLKIT_INCLUDE})
...
if (CUDA_FOUND)
    ...
    if (${CUDA_VERSION_STRING} VERSION_GREATER_EQUAL "12.4")
    ...
    elseif (${CUDA_VERSION_STRING} VERSION_GREATER_EQUAL "11.1")
        execute_process(COMMAND ${CMAKE_CUDA_COMPILER} --list-gpu-code RESULT_VARIABLE EXIT_CODE OUTPUT_VARIABLE OUTPUT_VAL)
        if (EXIT_CODE EQUAL 0)
            string(REPLACE "sm_" "" OUTPUT_VAL ${OUTPUT_VAL})
            string(REPLACE "\n" ";" __CUDA_ARCH_BIN ${OUTPUT_VAL})
